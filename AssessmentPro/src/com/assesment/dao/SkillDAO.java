...
public class SkillDAO {
	public static void Search(Connection connection,SkillBO sbo) throws SQLException{
		String skill;
		skill=sbo.getSkillname();
		Statement st= connection.createStatement();
		ResultSet rs = st.executeQuery("select playername,country,skill,teamname from players where skill='"+skill+"'");
